//
//  SHKEvernote+ILSShareHtml.m
//  ShareKit
//
//  Created by jia on 2/5/13.
//
//

#import "SHKEvernote+ILSShareHtml.h"
#import "EvernoteSDK.h"
#import "GTMNSString+HTML.h"

@implementation SHKEvernote (ILSShareHtml)
#pragma mark -
...
- (BOOL)send {
    ...
    if(![note contentIsSet]) {
        ...
        if(item.text.length>0 ){
            [contentStr appendFormat:@"<div>%@</div>", item.text];
        }
        if(item.image) {
