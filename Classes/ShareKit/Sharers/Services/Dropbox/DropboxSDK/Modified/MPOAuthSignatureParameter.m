...
//
/*
 *  MPOAuthSignatureParameter was modified to get compability with ShareKit.
 *  Removed:
 *   - #include "DBBase64Transcoder.h" - original SDK
 *  Added:
 *   - #include "Base64Transcoder.h" - ShareKit version in core library
 *  Modified:
 *   - 'DBBase64EncodeData' to 'Base64EncodeData'
 */
